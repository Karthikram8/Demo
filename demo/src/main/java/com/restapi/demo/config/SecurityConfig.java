	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.csrf(csrf->csrf.disable())
			.authorizeHttpRequests((authorize) -> authorize
				...
				.requestMatchers("/api/patient/add/{userId}/{medHisId}").hasAuthority("PATIENT")
				.requestMatchers("/api/appointment/add/{pId}/{dId}").permitAll()
				.requestMatchers("/api/appointment/get-patient-by-doctor/{dId}").hasAuthority("DOCTOR")
